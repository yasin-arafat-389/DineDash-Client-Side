          ...
          <div className="mb-16 grid grid-cols-2 gap-12 pt-10 md:grid-cols-4 lg:grid-cols-6 lg:gap-8 lg:pt-12">
            ...
            <div>
              ...
              <nav className="flex flex-col gap-4">
                <div>
                  <Link
                    to={"/restaurants/Pizza%20Hut"}
                    className="text-gray-600 transition duration-100 hover:text-indigo-500 active:text-indigo-600"
                  >
                    Pizza Hut
                  </Link>
                </div>
            ...
            <div>
              ...
              <nav className="flex flex-col gap-4">
                <div>
                  <Link
                    target="_blank"
                    to={"https://www.facebook.com/HungryNaki/"}
                    className="text-gray-600 transition duration-100 hover:text-indigo-500 active:text-indigo-600"
                  >
                    HungryNaki
                  </Link>
                ...
                <div>
                  <Link
                    target="_blank"
                    to={"https://www.shohoz.com/food-merchant"}
                    className="text-gray-600 transition duration-100 hover:text-indigo-500 active:text-indigo-600"
                  >
                    Shohoz
                  </Link>
